...
#include "pair_table_nuebar.c"

double pair_tbl_nuebar(double Enu, double lg_T, double lg_rhoYe)
{
...
//   if( flavour==4 ) printf("flavour==%d",flavour);
  ...
  return trilinear_interp(Enu, lg_T, lg_rhoYe, &thermal_Enuebar[0][0][0],
